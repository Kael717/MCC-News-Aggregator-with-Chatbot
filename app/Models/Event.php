...
class Event extends Model
{
    ...
    private function buildPublicUrl(string $relativePath): string
    {
        ...
        try {
            ...
            if (!filter_var($url, FILTER_VALIDATE_URL)) {
                throw new \Exception('Invalid URL generated by Storage facade');
            }
            ...
            $fallbackUrl = asset('storage/' . ltrim($relativePath, '/'));
            ...
            // Fallback 2: Manual URL construction
            $appUrl = config('app.url', request()->getSchemeAndHttpHost());
            $cleanPath = ltrim($relativePath, '/');
            $manualUrl = rtrim($appUrl, '/') . '/storage/' . $cleanPath;
    ...
    public function getAllImageUrlsAttribute()
    {
        ...
        // Convert file paths to full URLs using enhanced buildPublicUrl method
